...
<body>
  <div class="header-top">
	 <div class="wrap"> 
		<div class="logo">
			<a href="index.html"><img src="images/logo copy.png" alt=""/></a>
	    </div>
	    <div class="cssmenu">
		   <ul>
   	...
   	<div class="wrap">
		...
		<ul class="megamenu skyblue">
		    <li><a class="color1" href="index.html">Home</a></li>
				<li><a class="color2" href="#">Mobiles</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
						...
						<div class="col1">
							<div class="h_nav">
								<h4>Accessories</h4>
								<ul>
									<li><a href="shop.html">COVERS</a></li>
									<li><a href="shop.html">POWER BANKS</a></li>
									<li><a href="shop.html">EARPHONES</a></li>
					...
					<div class="row">
						...
						<div class="col1"></div>
								...
								<li><a class="color7" href="#">Computers</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
					...
					<div class="row">
						...
						<div class="col1"></div>
								...
								<li><a class="color3" href="#">Watches & Sunglasses</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
					...
					<div class="row">
						...
						<div class="col1"></div>
								...
								<li><a class="color4" href="#">Health & Beauty</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
					...
					<div class="row">
						...
						<div class="col1"></div>
								...
								<li><a class="color5" href="#">Books</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
       	  ...
       	  <div class="wmuSlider example1" style="height: 560px;">
				  ...
				  <article style="position: relative; width: 100%; opacity: 1;"> 
				   	<div class="banner-wrap">
						 ...
						 <div class="slider-right">
						    <h1>iphone</h1>
						    <h2>black</h2>
						    <p>3G, 4.0″ LED-backlit IPS LCD display</p>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	 <div class="banner-wrap">
						 ...
						 <div class="slider-right">
						    <h1>dell</h1>
						    <h2>blue </h2>
						    <p>4th Gen Intel Core i5- 4GB RAM- 1TB HDD- 39.62cm (15.6)</p>
						    <div class="btn"><a href="shop.html">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
				   ...
				   <div class="box1">
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Classic Watch</h3>
					  	<p class="m_2">Watches</p>
				         <div class="grid_img">
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Dell Labtoptop</h3>
					  	<p class="m_2">Labtops</p>
					    <div class="grid_img">
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Iphone 5c</h3>
					  	<p class="m_2">Mobiles</p>
				         <div class="grid_img">
			  ...
			  <div class="box1">
				  <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Headphone</h3>
					  	<p class="m_2">Computer Accessories</p>
				         <div class="grid_img">
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Acer Iconia A200</h3>
					  	<p class="m_2">Tablets</p>
				         <div class="grid_img">
				   ...
				   <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	<h3 class="m_1">Round Sunglasses</h3>
					  	<p class="m_2">Sunglasses</p>
				         <div class="grid_img">
        ...
        <div class="footer">
       	  <div class="footer-top">
       		<div class="wrap">
				   ...
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
				  	 	<li><img src="images/f_icon1.png" alt=""/><span class="delivery">Customer Service :<span class="orange"> (********)</span></span></li>
				  	 </ul>
				   </div>
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
